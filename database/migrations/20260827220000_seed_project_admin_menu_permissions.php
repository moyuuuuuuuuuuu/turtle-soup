...
final class SeedProjectAdminMenuPermissions extends AbstractMigration
{
    ...
    public function down(): void
    {
        $this->getQueryBuilder('delete')
            ->delete('sa_system_role_menu')
            ->where(['role_id' => self::SUPER_ADMIN_ROLE_ID])
            ->whereInList('menu_id', self::MENU_IDS)
            ->execute();
    }
}
