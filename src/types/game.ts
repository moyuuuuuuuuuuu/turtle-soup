...
export interface GameSnapshot {
  ...
  room_id?: string | null
  status: 'created' | 'playing' | 'solved' | 'finished' | 'abandoned'
  difficulty: number
  ...
  used_hints: number[]
  discovered_points: string[]
  bottom?: string | null
  points?: Array<{ key: string, content: string, required: boolean, weight: number }> | null
  guess?: { content: string, is_solved: boolean, summary: string } | null
}
