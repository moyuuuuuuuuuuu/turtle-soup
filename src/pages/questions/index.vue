...
.view-toggle{margin-left:4px;gap:8px}.view-toggle button{box-sizing:border-box;width:42px;height:42px;margin:0;padding:0;border-radius:4px;align-items:center;justify-content:center;transition:border-color .18s,background-color .18s,color .18s}.view-toggle button.active{background:color-mix(in srgb,var(--foreground) 7%,transparent)}
