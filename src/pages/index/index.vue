  ...
  <view class="home-page">
    <section class="hero">
      <view class="hero-inner">
        ...
        <view class="quick-links" :class="{ 'single-link': !supportsPublicRooms }">
          ...
          <view v-if="supportsPublicRooms" class="quick-link" @click="openPublicRooms">
            <text class="quick-icon hgt-mono">
              02
            </text><view>
              <text class="quick-title">
