...
<template>
  ...
  <view v-else class="profile-page guest-page">
    ...
    <view v-if="!loading" class="guest-content">
      <view class="guest-brand" aria-label="墨鱼海龟汤">
        <image class="guest-logo guest-logo-dark" src="/static/brand/logo-mark-dark.png" mode="aspectFit" />
        <image class="guest-logo guest-logo-light" src="/static/brand/logo-mark-light.png" mode="aspectFit" />
...
.guest-content{display:flex;box-sizing:border-box;width:min(620px,calc(100% - 56px));min-height:390px;margin:70px auto;padding:56px;border:1px solid var(--border);align-items:center;justify-content:center;background:var(--card);text-align:center;flex-direction:column}.guest-brand{display:flex;box-sizing:border-box;width:88px;height:88px;padding:10px;border:1px solid var(--border);align-items:center;justify-content:center}.guest-logo{display:block;width:66px;height:66px}.guest-logo-light{display:none}:global(.hgt-light) .guest-logo-dark{display:none}:global(.hgt-light) .guest-logo-light{display:block}.guest-title{margin-top:24px;font-size:28px}.guest-copy{max-width:440px;margin-top:16px;color:var(--muted-foreground);font-size:13px;line-height:1.9}.guest-actions{display:flex;width:100%;margin-top:30px;gap:12px}.guest-actions button{display:flex;height:44px;min-height:44px;margin:0;padding:0 20px;border:1px solid var(--foreground);border-radius:0;align-items:center;justify-content:center;font-size:11px;line-height:normal;letter-spacing:.14em;flex:1 1 0}.guest-primary{background:var(--foreground);color:var(--background)}.guest-secondary{background:transparent;color:var(--foreground)}.guest-note{margin-top:20px;color:var(--muted-foreground);font-size:9px;letter-spacing:.14em}
