...
<template>
  <view class="history-page">
    ...
    <view v-else-if="!loading" class="login-guide">
      <view class="guide-brand" aria-label="墨鱼海龟汤">
        <image class="guide-logo guide-logo-dark" src="/static/brand/logo-mark-dark.png" mode="aspectFit" />
        <image class="guide-logo guide-logo-light" src="/static/brand/logo-mark-light.png" mode="aspectFit" />
